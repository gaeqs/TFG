% Commented by Oscar \documentclass[twoside,a4paper,11pt]{book}
\documentclass[twoside,spanish,a4paper,11pt]{book}
% Commented by Oscar \usepackage[english]{babel}

\usepackage[utf8]{inputenc}
%% Added by Oscar
\usepackage[spanish,es-tabla,english]{babel}
% Commented by Oscar \usepackage[T1]{fontenc}
\usepackage{url}
...
\begin{document}
    ...
    % Commented by Oscar \printbibliography[title=Bibliografía]
