...
para el proyecto, \delODR{y terminando definiendo}\newODR{así como la definición de} los componentes más básicos desarrollados
...
con una comunidad grande y \textbf{rápid\delODR{o}\newODR{a} tanto en el desarrollo como en la ejecución}.
...
Estos requisitos reduce\newODR{n} la lista de tecnologías \delODR{en}\newODR{a} los siguientes candidatos:
\begin{itemize}
    \item \textbf{HTML, CSS y TypeScript:} este conjunto de tecnologías es muy popular actualmente
    para la creación de aplicaciones web y de escritorio. \textit{IDEs} muy \delODR{famosos}\newODR{conocidos} como
...
de un lustro no ayuda \delODR{en}\newODR{a} su reputación.
...
La velocidad de ejecución también se ha incrementado considerablemente, \delODR{posicionándose}\newODR{convirtiéndose} en uno de los
lenguajes de programación que más rápido ejecuta\delODR{n}.
...
En él se especifican las dependencias y se define cómo \newODR{se debe compilar} el proyecto \delODR{debe ser compilado}.
