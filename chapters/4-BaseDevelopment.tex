...
\begin{figure}[H]
    ...
    \caption{Editor de \textit{JAMS} en su forma más básica}
...
\begin{figure}[H]
    ...
    \caption{Editor de \textit{JAMS} con ventanas desplegadas}
...
\begin{figure}[H]
    ...
    \caption{Editor de \textit{JAMS} con varias simulaciones creadas}
...
\begin{figure}[H]
    ...
    \caption{Ventana principal mostrando los proyectos recientes}
...
\begin{figure}[H]
    ...
    \caption{Ventana de creación de nuevos proyectos}
...
Estén definidas o no las dependencias,
...
$EditorIndexedElement$ es la interfaz principal
