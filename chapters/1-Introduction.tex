...
\begin{itemize}
    ...
    \item Buscar un \textit{framework} de desarrollo de aplicaciones de escritorio
...
\note{Óscar: Yo creo que esto no hay que decirlo así: podemos comentarlo}Este objetivo está relacionado con los
